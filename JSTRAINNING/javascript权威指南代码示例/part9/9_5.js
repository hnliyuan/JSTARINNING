...
//这个例子的作者是Joshua Bloch 最初是基于Java写的，可以在这里查看到: http://jcp.org/aboutJava/communityprocess/jsr/tiger/enum.html
function Card(suit,rank){
	this.suit= suit;
	this.rank  = rank;
}
Card.Suit =  enumeration({Clubs: ,Diamonds: 2,Hearts: 3, Spades:4});
